...
/**
 * An instance of this class constitutes a Component which detects whether or
 * not a packet processed by previous modules is an attack packet. If it detects
 * an attack packet, it performs the enabled reactions like sending a report to
 * a syslog server and creating iptables rules.
 *
...
public class ComponentDetector extends ComponentActiveProcessorPdu<PduAtomic, PduAtomic> {
    ...
    /**
     * The model with which to compare the preprocessed data of the packets to
     */
    public final ModelLive model;
    /**
     * An object which keeps track of, and manages the rules created by the
     * ComponentDetector
     */
    public final RulesManager rulesManager;
    /**
     * An object which handles the delivery of syslog messages
     */
    public final SyslogIF syslogLogger;
    /**
     * A model of the required preprocessed data compatible with the model's
     * connection tree
     */
    ...
    /**
     * A queue of logs generated by the system
     */
    public final ConcurrentLinkedQueue<Log> logs;

    /**
     * Constructs a new ComponentDetector object.
     *
     * @param inQueue The input queue
     * @param model The model with which to compare the preprocessed data of the
     * packets to
     * @param rulesManager An object which keeps track of, and manages the rules
     * created by the ComponentDetector
     * @param syslogServer The IP Address of the syslog server to report to
     * @param syslogPort The port of the syslog server to report to
     */
