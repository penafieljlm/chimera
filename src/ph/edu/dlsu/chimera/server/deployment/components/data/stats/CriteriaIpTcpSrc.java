 ...
 */
public class CriteriaIpTcpSrc extends Criteria {

    public final InetAddress source;
    public final int sourcePort;

    public CriteriaIpTcpSrc() {
        this(null, -1);
    }

    public CriteriaIpTcpSrc(InetAddress source,
            int sourcePort) {
    ...
    public Criteria createInstance(PduAtomic pkt) {
        ...
        if (socks != null && pkt.packet.hasHeader(new Tcp())) {
            return new CriteriaIpTcpSrc(socks.source, socks.sourcePort);
        }
        return null;
    }
    ...
    public String getInstanceString() {
        return this.source.getHostAddress() + ":" + this.sourcePort + " -> any:any";
    }
}
