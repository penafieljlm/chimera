 ...
 */
public class CriteriaCompositeIpTcpSrcHttpPost extends CriteriaComposite {

    public final InetAddress source;
    public final int sourcePort;

    public CriteriaCompositeIpTcpSrcHttpPost() {
        this(null, -1);
    }

    public CriteriaCompositeIpTcpSrcHttpPost(InetAddress source, int sourcePort) {
        super("socktcpsrchttp", "Source TCP Socket Http POST Message");
        this.source = source;
    ...
    public CriteriaComposite createInstance(PduComposite pdu) {
        ...
        if (socks != null && pdu instanceof PduCompositeTcpHttp) {
            ...
            if (http.header.toUpperCase().startsWith("POST")) {
    ...
    public boolean equals(Object obj) {
        ...
        final CriteriaCompositeIpTcpSrcHttpPost other = (CriteriaCompositeIpTcpSrcHttpPost) obj;
    ...
    public int hashCode() {
        ...
        hash = 41 * hash + this.sourcePort;
        return hash;
    }

    @Override
    public String getInstanceString() {
        return this.source.getHostAddress() + ":" + this.sourcePort + " -[IP:TCP:HTTP:POST]> any:any";
    }
}
