...
public class DeploymentDebug extends Deployment {
    ...
    public DeploymentDebug(Assembly assembly, String ifInbound) {
        ...
        super.components.put("sniffer", new ComponentSniffer(assembly, inPcap, snifferOut, true));
        super.components.put("statetracker", new ComponentStateTracker(assembly, snifferOut, stateOut, stateTable, true));
        super.components.put("assembler", new ComponentAssembler(assembly, stateOut, assemblerOut, tcpPortProtocolLookup, null, stateTable));
        super.components.put("debugger", new ComponentDebugger(assembly, assemblerOut, null));
    }
